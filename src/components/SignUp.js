...
import { Pause, Done, Edit, KeyboardArrowLeft, KeyboardArrowRight, Close } from '@material-ui/icons';
                        ...
                        <ul className="list-unstyled d-flex">
                            <li hidden={row.isHospital === 1 ? false : true}>
                                <div>
                                    ...
                                    Hospital - <span> ${row.hospitalStartingAmount}</span>
                                </div>
                            </li>
                            <li hidden={row.isClinic === 1 ? false : true}>
                                <div>
                                    <FontAwesomeIcon icon={faClinicMedical} className="loc-clinic" />
                                    Clinic - <span> ${row.clinicStartingAmount}</span>
                                </div>
                            </li>
                            <li hidden={row.isRMS === 1 ? false : true}>
                                <div>
                                    <FontAwesomeIcon icon={faPlusSquare} className="loc-rms" />
                                    RMS - <span>${row.rmsStartingAmount}</span>
                                </div>
                            </li>
                        </ul>
                    </div>
...
function ClsSubscription(props) {
    ...
    const ScrollPriceCardLeft = () => {
        $(".price_card_repeater").animate({ scrollLeft: "-=360px" }, "slow");
    };
    ...
    function PriceNavbtnFunction() {
        ...
        $(".price_card_repeater").scroll(function () {
            if ($(this).scrollLeft() >= 25) {
                $("#scroll-priceleft").removeClass("invisible").addClass("visible");
                $("#scroll-priceright").removeClass("invisible").addClass("visible");
            }
            if ($(this).scrollLeft() <= 25) {
                $("#scroll-priceleft").removeClass("invisible").addClass("visible");
                $("#scroll-priceright").removeClass("visible").addClass("visible");
            }
            ...
            if ($(this).scrollLeft() === 0) {
                $("#scroll-priceleft").removeClass("visible").addClass("invisible");
            }
        });
    }
...
export default function SignUp(props) {
    ...
    const recordForChange = (val) => {
        if (val.open === true) {
            ...
            values.ZipCodeData = [{ "zipCode": values.Zip, "state": values.State, "city": values.City }];
        ...
        <Form onSubmit={handleSubmit}>
            ...
            <div hidden={values.signUpdiv}>
                <div className="col-XS-24 col-SM-24 col-MD-48 LarScr-48 flex-center-xy flex-column-xs" style={{ 'margin': '100px 0' }}>
                    <div className="col-XS-24 col-SM-11 col-MD-20 LarScr-16">
                        <img src={signupimg} alt="Sign up illustration" style={{ 'width': '100%' }} />
                    </div>
                        ...
                        <div className="col-XS-24 col-SM-20 col-SML-15 col-MD-36 LarScr-41">
                            <div className="col-XS-24 col-SM-24 col-MD-48 LarScr-48 p-0">
                                <TextField
                                    ...
                                    hidden={values.name}
                                    inputRef={input => (values.name === false && values.FirstName === "") ? input && input.focus() : null}
                                />
                            </div>
                            <div className="col-XS-24 col-SM-24 col-MD-48 LarScr-48 p-0">
                                <TextField
                            ...
                            <div className="col-XS-24 col-SM-24 col-MD-48 LarScr-48 p-0">
                                <TextField
                                    ...
                                    error={errors.Email}
                                    disabled={values.IsDisabled}
                                    inputRef={input => (values.name === true && values.Email === "") ? input && input.focus() : null}
                                />
                            ...
                            <div className="col-XS-24 col-SM-24 col-MD-48 LarScr-48 p-0">
                                <TextField
                                    ...
                                    hidden={values.isOTP}
                                    inputRef={input => (values.isOTP === false && values.Email !== "" && values.OTP === "") ? input && input.focus() : null}
                                />
            ...
            <div hidden={values.statusCheck} className="col-XS-24 col-SM-24 col-MD-48 LarScr-48 flex-center-x flex-column-xs" style={{ 'margin': '70px 0' }}>
                <div className="col-XS-24 col-SM-9 col-MD-20 LarScr-20">
                    <img src={Facilityinfoimg} alt="Facility info illustration" style={{ 'width': '100%' }} />
                </div>
                <div className="col-XS-24 col-SM-15 col-MD-28 LarScr-20 rhs_paddingleft">
                    ...
                    <div className="compstatus_actions">
                        <Button hidden={values.isRefesh} variant="contained" onClick={refreshClick}>Refresh</Button>
            ...
            <div hidden={values.facility} id="facilitydetails">
                <div className="col-XS-24 col-SM-24 col-MD-48 LarScr-48 flex-center-x flex-column-xs flex-column-sm" style={{ 'margin': '50px 0' }}>
                    <div className="col-XS-24 col-SM-24 col-MD-20 LarScr-20">
                        <img src={Facilityimg} alt="Facility details illustration" style={{ 'width': '100%' }} />
                    </div>
                        ...
                        <div className="col-XS-24 col-SM-24 col-SML-15 col-MD-48 LarScr-48 p-0 flex-wrap">
                            ...
                            <div hidden={values.isFacility}>
                                <div className="col-XS-24 col-SM-12 col-MD-24 LarScr-24">
                                    <TextField id="FacilityName" label="Facility Name" variant="outlined" name="CompanyName" type="text" value={values.CompanyName} onChange={handleInputChange} error={errors.CompanyName} />
                                </div>
                                <div className="col-XS-24 col-SM-12 col-MD-24 LarScr-24">
                                    <FormControl variant="outlined">
                                        <InputLabel id="demo-simple-select-outlined-label">Facility Type</InputLabel>
                                        <Select id="FacilityType" label="Facility Type" name="FacilityType" value={values.FacilityType} onChange={handleInputChange} error={errors.FacilityType}>
                                ...
                                <div className="col-XS-24 col-SM-24 col-MD-48 LarScr-48">
                                    <TextField id="Address1" label="Address1" variant="outlined" name="Address1" type="text" value={values.Address1} onChange={handleInputChange} error={errors.Address1} />
                                </div>
                                <div className="col-XS-24 col-SM-24 col-MD-48 LarScr-48">
                                    <TextField id="Address2" label="Address2" variant="outlined" name="Address2" type="text" value={values.Address2} onChange={handleInputChange} error={errors.Address2} />
                                </div>
                                <div className="col-XS-24 col-SM-24 col-MD-12 LarScr-12">
                                    <FormControl variant="outlined">
                                        <InputLabel id="demo-simple-select-label">Country</InputLabel>
                                        <Select id="CountryId" label="Country" name="Country" value={values.Country} onChange={handleInputChange} error={errors.Country} disabled={true}>
                                ...
                                <div className="col-XS-24 col-SM-24 col-MD-36 LarScr-36 p-0">
                                    <Autocomplete
                                        className="col-XS-24 col-SM-12 col-SML-12 col-MD-16 LarScr-16"
                                        id="combo-box-demo"
                                        name="zipCode"
                                        options={values.ZipCodeData}
                                        getOptionLabel={(option) => option.zipCode || values.Zip}
                                        getOptionSelected={(option, value) => option.zipCode === value.zipCode ? SelectedValue(value.zipCode, value.state, value.city) : false}
                                        renderOption={(option) => (
                                            <React.Fragment>
                                ...
                                <div className="col-XS-24 col-SM-12 col-MD-12 LarScr-12">
                                    <FormControl variant="outlined">
                                        <InputLabel htmlFor="phone-mask-input" className="MuiFormLabel-setfocus">Phone</InputLabel>
                                        <OutlinedInput id="phone-mask-input" value={values.Phone} error={errors.Phone} onChange={handleInputChange} name="Phone" type="text" inputComponent={TextMaskCustom} />
                                    </FormControl>
                                </div>
                                <div className="col-XS-24 col-SM-12 col-MD-12 LarScr-12">
                                    <FormControl variant="outlined">
                                        <InputLabel htmlFor="fax-mask-input" className="MuiFormLabel-setfocus">Fax</InputLabel>
                                        <OutlinedInput id="fax-mask-input" value={values.Fax} error={errors.Fax} onChange={handleInputChange} name="Fax" type="text" inputComponent={TextMaskCustom} />
                                    </FormControl>
                                </div>
                                <div className="col-XS-24 col-SM-12 col-MD-24 LarScr-24">
                                    <FormControl variant="outlined">
                                        <InputLabel htmlFor="mobile-mask-input">Mobile</InputLabel>
                                        <OutlinedInput id="mobile-mask-input" value={values.Mobile} error={errors.Mobile} onChange={handleInputChange} name="Mobile" type="text" inputComponent={TextMaskCustom} />
                                    </FormControl>
                                </div>
                                <div className="col-XS-24 col-SM-12 col-MD-24 LarScr-24">
                                    <FormControl variant="outlined">
                                        <InputLabel htmlFor="taxid-mask-input">Tax ID</InputLabel>
                                        <OutlinedInput id="taxid-mask-input" value={values.TaxId} error={errors.TaxId} onChange={handleInputChange} name="TaxId" type="text" inputComponent={TextMaskCustomTaxId} />
                                    </FormControl>
                                </div>
                                <div className="col-XS-24 col-SM-24 col-MD-24 LarScr-24">
                                    <FormControl variant="outlined">
                                        <InputLabel htmlFor="npi-mask-input" className="MuiFormLabel-setfocus">National Provider Identifier (NPI)</InputLabel>
                                        <OutlinedInput id="npi-mask-input" value={values.NPI} error={errors.NPI} onChange={handleInputChange} name="NPI" type="text" inputComponent={TextMaskCustomNPI} />
                                    </FormControl>
                                </div>
                                <div className="col-XS-24 col-SM-24 col-MD-24 LarScr-24">
                                    <TextField id="Email" label="Email" variant="outlined" name="EmailAddress" type="Email" value={values.EmailAddress} onChange={handleInputChange} error={errors.EmailAddress} disabled={values.IsDisabled} />
                                </div>
                                <div className="col-XS-24 col-SM-12 col-MD-12 LarScr-12">
                                    <FormControl variant="outlined">
                                        <InputLabel id="salutation-label">Salutation</InputLabel>
                                        <Select labelId="salutation-label" id="Salutation" label="Salutation" name="Salutation" value={values.Salutation} onChange={handleInputChange} error={errors.Salutation}>
                                ...
                                <div className="col-XS-24 col-SM-12 col-MD-24 LarScr-24" style={{ 'clear': 'both' }}>
                                    <TextField id="ContactFirstName" label="Contact Person First Name" variant="outlined" name="ContactFirstName" type="text" value={values.ContactFirstName} onChange={handleInputChange} error={errors.ContactFirstName} disabled={values.IsDisabled} />
                                </div>
                                <div className="col-XS-24 col-SM-12 col-MD-24 LarScr-24">
                                    <TextField id="ContactLastName" label="Contact Person Last Name" variant="outlined" name="ContactLastName" type="text" value={values.ContactLastName} onChange={handleInputChange} error={errors.ContactLastName} disabled={values.IsDisabled} />
                                </div>
                                <div className="col-XS-24 col-SM-12 col-MD-12 LarScr-12">
                                    <TextField id="NoOfProvider" label="No. of Provider" variant="outlined" name="NoOfProvider" type="text" value={values.NoOfProvider} onChange={handleInputChange} error={errors.NoOfProvider} />
                                </div>
                                <div className="col-XS-24 col-SM-12 col-MD-12 LarScr-12">
                                    <TextField id="NoOfNurse" label="No. of Nurse" variant="outlined" name="NoOfNurse" type="text" value={values.NoOfNurse} onChange={handleInputChange} />
                                </div>
                            </div>
                        </div>
                        <br /><br />
                        <div hidden={values.isFacility} className="col-XS-24 col-SM-24 col-MD-48 LarScr-48 p-0 m-2">
                            <Button variant="contained" onClick={facilitySave} color="primary">Submit</Button>
                        </div>
                    </div>
                </div>
            </div>
...
export class NpiSearch extends React.Component {
    ...
    textChange = (e) => {
        ...
        this.setState({ ...this.state, [name]: text, npiRecords: '' });
    }
        ...
        return (
            <form autoComplete="off">
                <div className="col-XS-24 col-SM-12 col-MD-24 LarScr-24">
                    <FormControl variant="outlined">
                        <InputLabel id="demo-simple-select-label">Country</InputLabel>
                        <Select id="CountryId" label="Country" name="Country" value={this.state.Country} onChange={this.handleInputChange}>
                            <MenuItem value={1}>USA</MenuItem>
                            <MenuItem value={2}>Columbia</MenuItem>
                        </Select>
                    </FormControl>
                ...
                <div hidden={this.state.Country !== 1} className="col-XS-24 col-SM-12 col-MD-24 LarScr-24 flex-center-y">
                    <FormControl variant="outlined">
                        <InputLabel htmlFor="npi-search-input" className="MuiFormLabel-setfocus">NPI</InputLabel>
                        <OutlinedInput
                    ...
                    <div>
                        <Button onClick={this.handleSubmit} variant="outlined" color="primary">Find NPI</Button>
                    </div>
                </div>
                <div>
                    <StepLabel className="pl-2" error={true} style={{ 'float': 'right', 'margin': '0px 226px' }}>
                        {this.state.npiRecords}
                    </StepLabel>
                </div>
                <Dialog
                        ...
                        <DialogContentText id="alert-dialog-description">
                            <table className="table table-bordered" style={{ 'fontSize': '0.9rem' }}>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>Status</td>
                                        <td><span>{this.state.Status === '' ? '' : this.state.NPIValues.basic.status === 'A' ? 'Active' : 'In-Active'}</span></td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div>{this.state.PrimaryAdd === '' ? '' : this.state.NPIValues.addresses[0].address_1},</div>
